...
public class MAinActivity2 extends Service implements LocationListener {
    ...
    public void GPStrace(Context context) {
    ...
    public void showSettingAlert(){ AlertDialog.Builder alertDialog=new AlertDialog.Builder(context);
